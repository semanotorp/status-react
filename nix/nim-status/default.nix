...
in rec {
  ...
  android-x86 = callPackage ./nim-status.nix { 
    platform = "android"; 
    arch = "386"; 
  };
  android-arm = callPackage ./nim-status.nix { 
    platform = "androideabi"; 
    arch = "arm";
  };
  android-arm64 = callPackage ./nim-status.nix {
    platform = "android"; 
    arch = "arm64";
  };

  ios-x86 = callPackage ./nim-status.nix { 
    platform = "ios"; 
    arch = "386"; 
  };
  ios-arm = callPackage ./nim-status.nix {
    platform = "ios"; 
    arch = "arm"; 
  };
  ios-arm64 = callPackage ./nim-status.nix {
    platform = "ios"; 
    arch = "arm64"; 
  };
